...
$descripcion_twitter = 'Hogar Pasítea una bonita casa en el fraccionamiento residencial Hacienda Real ubicado en la parte Oriente del área metropolitana de Guadalajara, ideal para vivir en un ambiente familiar y de tranquilidad, ya que cuenta con ingreso controlado y muro perimetral.  '; //falta por automatizar
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <?php include $generales->path_base.'templates/galeria/hogar-pasitea/_galeria_hogar.php' ?> <!-- falta por automatizar -->
