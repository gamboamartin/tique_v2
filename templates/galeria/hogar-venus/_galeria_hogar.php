<?php
    $a = $generales->url_base."assets/img/venta_casas/hogar_venus/1Fachada/9 (1).jpg";
    $b = $generales->url_base."assets/img/venta_casas/hogar_venus/2Sala/13 (1).jpg";
    $c = $generales->url_base."assets/img/venta_casas/hogar_venus/4Recamara1/18.jpg";
?>
